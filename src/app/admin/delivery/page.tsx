...
export default function DeliveryTariffsPage() {
  ...
  const saveCommuneCounts = () => {
    ...
    toast({ title: "Villes mises à jour", description: `Le nombre de bureaux et adresses pour ${managingState} ont été enregistrés.` });
  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-muted-foreground">Définissez les frais de port par wilaya and manage desktop locations.</p>
      </div>
        ...
        <DialogContent className="max-w-4xl rounded-[2rem] overflow-hidden p-0">
          <DialogHeader className="p-8 bg-muted/30 border-b">
            <DialogTitle className="text-2xl font-black uppercase flex items-center gap-3">
              ...
              Bureaux de Retrait - {managingState}
            </DialogTitle>
            <DialogDescription className="font-bold">
              Indiquez le nombre de bureaux et l'adresse exacte pour chaque ville.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="p-8">
            <ScrollArea className="h-[500px] pr-4">
              <div className="grid grid-cols-1 gap-4">
                {managingState && ALGERIA_DATA[managingState].map(commune => (
                  <div key={commune} className="grid grid-cols-1 md:grid-cols-12 items-center gap-4 p-4 bg-muted/20 border rounded-2xl transition-colors hover:bg-muted/40">
